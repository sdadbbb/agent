...
class LoggerUtil:
    ...
    def get_logger(name='agent'):
        ...
        fmt = logging.Formatter('%(asctime)s [%(levelname)s] %(funcName)s - %(message)s', datefmt='%H:%M:%S')
        ...
        file_fmt = logging.Formatter('%(asctime)s [%(levelname)s] %(name)s %(funcName)s - %(message)s')
